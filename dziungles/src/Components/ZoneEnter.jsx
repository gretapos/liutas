...
function ZoneEnter({showIt}) {
    ...
    return (
        <div className="zone-enter">
            ...
            <div><span> Shape: </span><select onChange={e => formControl(e, 'shape')} value={shape}>
                <option value="c">Circle</option>
                <option value="s" >Square</option>
                <option value="hl">Vertical line</option>
                <option value="vl" >Horizontal line</option>
                </select></div>
            <button onClick={showClick}>Spausti</button>
